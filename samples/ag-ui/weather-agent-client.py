...
"""
Weather Agent Client using basic-agent.py pattern

Demonstrates OpenAIChatClient usage for weather queries.
Connects directly to OpenAI with weather tools.
"""
...
async def main() -> None:
    print("=" * 70)
    print("Weather Agent - Interactive Client")
    print("=" * 70)
    ...
    print("Commands:")
    print("  - Ask about weather: 'What's the weather?'")
    print("  - Set your location: 'My location is Paris'")
    ...
    while True:
        ...
        try:
            response = await client.get_response(full_message, tools=get_weather_at_location)
